-- ========================================
-- Silver Layer Insert Script
-- Date: 2025-06-03
-- Purpose: Insert cleansed and processed data into Silver Layer tables from Bronze Layer
-- ========================================

-- 1. Insert into silver.crm_cust_info
-- Load latest customer records with normalized marital status and gender.
...
-- Normalize product data, extract category id and product key, handle null costs.
...
-- Clean and correct sales transactions, fix invalid dates and recalculate sales/prices if inconsistent.
...
-- Clean customer data: remove prefix from IDs, nullify future birthdates, normalize gender.
...
-- Clean location data: remove hyphens from IDs, map country codes to full names.
...
-- Load product category data as-is.
